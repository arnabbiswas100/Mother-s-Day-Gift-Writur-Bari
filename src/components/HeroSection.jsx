  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-sm mx-auto">
        ...
        {/* Bengali title */}
        <motion.h1
          className="font-bengali text-4xl sm:text-5xl leading-tight mb-2"
          style={{ color: "#2a1f10" }}
        ...
        {/* English title */}
        <motion.p
          className="font-english italic text-lg sm:text-xl mb-8 opacity-50"
          style={{
            color: "#4a3a28",
        ...
        {/* Divider */}
        <motion.div
          className="w-px h-10 mx-auto mb-8 opacity-30"
        ...
        {/* Subtitle */}
        <motion.p
          className="font-bengali text-sm leading-loose opacity-55"
          style={{ color: "#4a3a28" }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.55 }}
          transition={{ duration: 1.5, delay: 1.3 }}
        >
          চার ঋতুর মধ্যে দিয়ে একটি জীবনের যাত্রা —
          <br />
        ...
        {/* Scroll cue */}
        <motion.button
          onClick={scrollToSpring}
          className="mt-12 flex flex-col items-center gap-2 mx-auto group"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
