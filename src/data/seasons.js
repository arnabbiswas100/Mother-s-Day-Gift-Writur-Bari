...
export const seasons = [
  {
    ...
    reflectionBengali:
      "সেই বাড়িটার কথা মনে পড়ে। দুপুরের রোদ যখন উঠোনে এসে পড়ত, মা তখন রান্নাঘরে। ধানের শিষের মতো সেই দিনগুলো — কোমল, সোনালি, অনায়াসে ভুলে যাওয়া। কিন্তু বুকের ভেতর কোথাও তারা থেকে যায়।",
    book: {
      title: "ডাকঘর",
      titleEnglish: "Dak Ghar",
      season: "গ্রীষ্ম",
      description: "শৈশবের নিষ্পাপ স্বপ্ন আর মুক্তির আকাঙ্ক্ষার কথা।",
      cover: "/images/spring-book.jpg",
